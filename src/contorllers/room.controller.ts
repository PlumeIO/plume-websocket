...
export const joinRoom = (req: Request, res: Response) => {
  ...
  if (!room) {
    ...
    if (user.room !== undefined) {
      ...
      console.log("user joined room", userId, roomId, room.users.length, config.rooms.length)
    } else {
...
export const exitRoom = (req: Request, res: Response) => {
  ...
  if (!room) {
    ...
    console.log("user exited room", user.id, room.id, room.users.length, config.rooms.length)
  } else {
